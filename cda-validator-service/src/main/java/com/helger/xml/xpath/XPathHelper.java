...
import dk.medcom.cda.validation.validationengine.ClasspathResourceURIResolver;
...
public final class XPathHelper
{
  ...
  public static XPathFactory createXPathFactorySaxonFirst ()
  {
    ...
    try
    {
      ...
      saxonFactory.getConfiguration().setURIResolver(new ClasspathResourceURIResolver());
