...
Item: (HealthConcernSection)
-->
    <rule context="*[hl7:section[hl7:templateId[@root = '1.2.208.184.15.1.10.20.1'][@extension = '2018-09-28']]]/hl7:section[hl7:templateId[@root = '1.2.208.184.15.1.10.20.1'][@extension = '2018-09-28']]" id="d131e691-false-d1934806e0">
...
Item: (HealthConcernSection)
-->
    <rule context="*[hl7:section[hl7:templateId[@root = '1.2.208.184.15.1.10.20.1'][@extension = '2018-09-28']]]/hl7:section[hl7:templateId[@root = '1.2.208.184.15.1.10.20.1'][@extension = '2018-09-28']]/hl7:templateId[@root = '1.2.208.184.15.1.10.20.1'][@extension = '2018-09-28']" id="d131e694-false-d1935348e0">
        <extends rule="II"/>
...
Item: (HealthConcernSection)
-->
    <rule context="*[hl7:section[hl7:templateId[@root = '1.2.208.184.15.1.10.20.1'][@extension = '2018-09-28']]]/hl7:section[hl7:templateId[@root = '1.2.208.184.15.1.10.20.1'][@extension = '2018-09-28']]/hl7:id" id="d131e697-false-d1935367e0">
        <extends rule="II"/>
        <assert role="error" see="http://art-decor.org/art-decor/decor-templates--medcom-documents-?id=1.2.208.184.15.1.10.20.1" test="(local-name-from-QName(resolve-QName(@xsi:type,.))='II' and namespace-uri-from-QName(resolve-QName(@xsi:type,.))='urn:hl7-org:v3') or not(@xsi:type)">(HealthConcernSection): If an @xsi:type instruction is present it SHALL be valued "{urn:hl7-org:v3}:II". Found "{<value-of select="namespace-uri-from-QName(resolve-QName(@xsi:type,.))"/>}:<value-of select="local-name-from-QName(resolve-QName(@xsi:type,.))"/>"</assert>
    </rule>
   <!--
...
Item: (HealthConcernSection)
-->
    <rule context="*[hl7:section[hl7:templateId[@root = '1.2.208.184.15.1.10.20.1'][@extension = '2018-09-28']]]/hl7:section[hl7:templateId[@root = '1.2.208.184.15.1.10.20.1'][@extension = '2018-09-28']]/hl7:code[(@code = '75310-3' and @codeSystem = '2.16.840.1.113883.6.1')]" id="d131e698-false-d1935377e0">
        <extends rule="CE"/>
...
Item: (HealthConcernSection)
-->
    <rule context="*[hl7:section[hl7:templateId[@root = '1.2.208.184.15.1.10.20.1'][@extension = '2018-09-28']]]/hl7:section[hl7:templateId[@root = '1.2.208.184.15.1.10.20.1'][@extension = '2018-09-28']]/hl7:title[not(@nullFlavor)]" id="d131e700-false-d1935392e0">
        <extends rule="ST"/>
...
Item: (HealthConcernSection)
-->
    <rule context="*[hl7:section[hl7:templateId[@root = '1.2.208.184.15.1.10.20.1'][@extension = '2018-09-28']]]/hl7:section[hl7:templateId[@root = '1.2.208.184.15.1.10.20.1'][@extension = '2018-09-28']]/hl7:text[not(@nullFlavor)]" id="d131e701-false-d1935401e0">
...
Item: (HealthConcernSection)
-->
    <rule context="*[hl7:section[hl7:templateId[@root = '1.2.208.184.15.1.10.20.1'][@extension = '2018-09-28']]]/hl7:section[hl7:templateId[@root = '1.2.208.184.15.1.10.20.1'][@extension = '2018-09-28']]/hl7:confidentialityCode[concat(@code, @codeSystem) = doc('include/voc-2.16.840.1.113883.1.11.16926-DYNAMIC.xml')//valueSet[1]/conceptList/concept/concat(@code, @codeSystem) or @nullFlavor]" id="d131e702-false-d1935413e0">
        <extends rule="CE"/>
        <assert role="error" see="http://art-decor.org/art-decor/decor-templates--medcom-documents-?id=1.2.208.184.15.1.10.20.1" test="(local-name-from-QName(resolve-QName(@xsi:type,.))='CE' and namespace-uri-from-QName(resolve-QName(@xsi:type,.))='urn:hl7-org:v3') or not(@xsi:type)">(HealthConcernSection): If an @xsi:type instruction is present it SHALL be valued "{urn:hl7-org:v3}:CE". Found "{<value-of select="namespace-uri-from-QName(resolve-QName(@xsi:type,.))"/>}:<value-of select="local-name-from-QName(resolve-QName(@xsi:type,.))"/>"</assert>
...
Item: (HealthConcernSection)
-->
    <rule context="*[hl7:section[hl7:templateId[@root = '1.2.208.184.15.1.10.20.1'][@extension = '2018-09-28']]]/hl7:section[hl7:templateId[@root = '1.2.208.184.15.1.10.20.1'][@extension = '2018-09-28']]/hl7:languageCode" id="d131e704-false-d1935435e0">
        <extends rule="CS"/>
...
-->
    <rule context="*[hl7:section[hl7:templateId[@root = '1.2.208.184.15.1.10.20.1'][@extension = '2018-09-28']]]/hl7:section[hl7:templateId[@root = '1.2.208.184.15.1.10.20.1'][@extension = '2018-09-28']]/hl7:entry">
        <extends rule="d1937444e0-false-d1938431e0"/>
...
-->
    <rule id="d1937444e0-false-d1938431e0" abstract="true">
