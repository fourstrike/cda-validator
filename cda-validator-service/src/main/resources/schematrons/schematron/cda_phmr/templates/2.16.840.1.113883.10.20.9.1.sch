...
<!ENTITY baseURI "">
<!ENTITY ent-2.16.840.1.113883.10.20.9.1 SYSTEM '2.16.840.1.113883.10.20.9.1.ent'>
]>
<schema xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:cda="urn:hl7-org:v3">

    <title>CDA PHMR Medical Equipment Constraints</title>
    ...
    <phase id='note'>
        <!--<active pattern='p-2.16.840.1.113883.10.20.9.1-note'/> -->
    </phase>
