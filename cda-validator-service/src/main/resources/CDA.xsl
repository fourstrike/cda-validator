<?xml version="1.0" encoding="UTF-8"?><!--
  ...
  Revision History: 2019-03-25 Torben Amtoft - Translation to Danish
...
&#13;"':;?`{}“”„‚’</xsl:text>
  ...
  <xsl:variable xmlns:n1="urn:hl7-org:v3" xmlns:in="urn:lantana-com:inline-variable-data" name="title">
    <xsl:choose>
      ...
      <xsl:otherwise>
        <xsl:text>Klinisk Dokument</xsl:text>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:variable>
  ...
  <xsl:template xmlns:n1="urn:hl7-org:v3" xmlns:in="urn:lantana-com:inline-variable-data" name="make-tableofcontents">
    ...
    <nav class="cda-render hidden-print hidden-xs hidden-sm affix toc-box" id="navbar-cda">
      ...
      <ul class="cda-render nav nav-stacked fixed" id="navbar-list-cda">
        <li>
          <a class="cda-render lantana-toc" href="#top">TILBAGE TIL TOPPEN</a>
        </li>
        <li>
          <a class="cda-render lantana-toc" href="#cda-patient">PATIENT DATA</a>
        </li>
        <li>
          <a class="cda-render lantana-toc" href="#author-performer">UDSTEDER DETALJER</a>
        </li>
        <li>
          <a class="cda-render lantana-toc bold" href="#doc-clinical-info">Kliniske sektioner</a>
        ...
        <li>
          <a class="cda-render lantana-toc" href="#doc-info">UDSTEDER</a>
        </li>
      </ul>
    </nav>
  </xsl:template>
  ...
  <xsl:template xmlns:n1="urn:hl7-org:v3" xmlns:in="urn:lantana-com:inline-variable-data" name="documentGeneral">
    <div class="container-fluid">
      <h2 class="section-title col-md-6">
        <xsl:text>Dokument Information</xsl:text>
      </h2>
      <div class="table-responsive col-md-6">
        <table class="table table-hover">
          <thead>
            <tr>
              <!--<th>
                <xsl:text>Dokument Identifikation</xsl:text>
              </th>-->
              <th>
                <xsl:text>Dokument Etableret</xsl:text>
              </th>
            </tr>
    ...
    <table class="header_table">
      <tbody>
        <td class="td_header_role_name">
          <xsl:text>Fortrolighed</xsl:text>
        </td>
        <td class="td_header_role_value">
          <xsl:choose>
            ...
            <xsl:when test="n1:confidentialityCode/@code = 'R'">
              <xsl:text>Begrænset</xsl:text>
            </xsl:when>
            <xsl:when test="n1:confidentialityCode/@code = 'V'">
              <xsl:text>Meget begrænset</xsl:text>
            </xsl:when>
          </xsl:choose>
          ...
          <div class="container-fluid">
            ...
            <div class="col-md-6">
              <xsl:if test="n1:addr | n1:telecom">
                <h2 class="section-title col-md-6">Kontakt</h2>
                <div class="header-group-content col-md-8">
    ...
    <xsl:if test="n1:authenticator">
      <div class="header container-fluid">
        <xsl:for-each select="n1:authenticator">
          <div class="col-md-6">
            <h2 class="section-title col-md-6">
              <xsl:text>Underskrevet</xsl:text>
            </h2>
            <div class="header-group-content col-md-8">
              <xsl:call-template name="show-name">
    ...
    <div class="container-fluid">
      <xsl:if test="n1:legalAuthenticator">
        <div class="header container-fluid">
          <div class="col-md-6">
            <h2 class="section-title col-md-6">
              <xsl:text>Lovmæssig godkendelse</xsl:text>
            </h2>
            <div class="header-group-content col-md-8">
          ...
          <xsl:if test="n1:legalAuthenticator/n1:assignedEntity/n1:addr | n1:legalAuthenticator/n1:assignedEntity/n1:telecom">
            <div class="col-md-6">
              <h2 class="col-md-6 section-title">Kontakt</h2>
              <div class="header-group-content col-md-8">
                <xsl:call-template name="show-contactInfo">
  ...
  <xsl:template xmlns:n1="urn:hl7-org:v3" xmlns:in="urn:lantana-com:inline-variable-data" name="dataEnterer">
    <xsl:if test="n1:dataEnterer">
      <div class="container-fluid header">
        <div class="col-md-6">
          <h2 class="section-title col-md-6">
            <xsl:text>Skrevet ind af</xsl:text>
          </h2>
          ...
          <div class="container-fluid col-md-8">
            <div class="container-fluid">
                    ...
                    <xsl:when test="n1:code">
                      <!--<div class="row">
                        <div class="attribute-title col-md-2">
                          <xsl:text>Identifikation</xsl:text>
                        </div>
                        <div class="col-md-6">
                          <xsl:call-template name="show-id">
                            <xsl:with-param name="id" select="n1:id"/>
              ...
              <xsl:if test="n1:responsibleParty">
                <div class="col-md-6">
                  <h2 class="section-title col-md-6">
                    <xsl:text>Ansvarlig parti</xsl:text>
                  </h2>
                  <div class="header-group-content col-md-8">
                    <xsl:call-template name="show-assignedEntity">
  ...
  <xsl:template xmlns:n1="urn:hl7-org:v3" xmlns:in="urn:lantana-com:inline-variable-data" name="custodian">
    <xsl:if test="n1:custodian">
      <div class="container-fluid header">
        <div class="col-md-6">
          <h2 class="section-title col-md-6">
            <xsl:text>Dokument vedligeholdt af</xsl:text>
          </h2>
          <div class="header-group-content col-md-8">
            <xsl:choose>
            ...
            <div class="header-group container-fluid">
              ...
              <div class="container-fluid">
                <h2 class="section-title col-md-6" id="service-event">
                  <xsl:text>Service begivenhed</xsl:text>
                </h2>
                <div class="header-group-content col-md-8">
                  <xsl:call-template name="show-assignedEntity">
  ...
  <xsl:template xmlns:n1="urn:hl7-org:v3" xmlns:in="urn:lantana-com:inline-variable-data" name="inFulfillmentOf">
    <xsl:if test="n1:infulfillmentOf">
      <xsl:for-each select="n1:inFulfillmentOf">
        <xsl:text>Til opfyldelse af</xsl:text>
      ...
      <xsl:if test="n1:informationRecipient">
        <div class="container-fluid header">
          <xsl:for-each select="n1:informationRecipient">
            <div class="container-fluid">
              <h2 class="section-title col-md-6">
                <xsl:text>Informationsmodtager</xsl:text>
              </h2>
              <div class="col-md-6 header-group-content">
                <xsl:choose>
        ...
        <xsl:if test="not(n1:id/@nullFlavor)">
          <div class="patient-heading container-fluid">
            ...
            <div class="patient-identifier container-fluid">
              <div class="attribute-title row">Patient Identifikation</div>
              <xsl:for-each select="n1:id">
                <div class="row">
          ...
          <div class="patient-info container-fluid">
            <div class="col-md-6">
              <h2 class="section-title col-md-6">DATA</h2>
              <div class="header-group-content col-md-8">
                <div class="row">
                  <div class="attribute-title col-md-6">
                    <xsl:text>Fødselsdato</xsl:text>
                  </div>
                  <div class="col-md-6">
                    <xsl:call-template name="show-time">
                      ...
                      <xsl:choose>
                        ...
                        <xsl:otherwise>
                          <span class="generated-text">
                            <xsl:text>Information ikke tilgængelig</xsl:text>
                          </span>
                        </xsl:otherwise>
                      </xsl:choose>
                    </div>
        ...
        <xsl:for-each select="n1:participant">
          <xsl:if test="n1:associatedEntity/@classCode = 'ECON'">
            <div class="container-fluid" id="emergency-contact">
              <div class="col-md-6">
                <h2 class="section-title col-md-6">Kontakt ved kritisk situation</h2>
                <div class="header-group-content col-md-8">
                  <xsl:call-template name="show-associatedEntity">
                    <xsl:with-param name="assoEntity" select="n1:associatedEntity"/>
                  </xsl:call-template>
        ...
        <tbody>
          <xsl:for-each select="n1:relatedDocument">
            <tr>
              <td class="td_header_role_name">
                <span class="td_label">
                  <xsl:text>Tilknyttet dokumentation</xsl:text>
                </span>
              </td>
              <td class="td_header_role_value">
    ...
    <xsl:if test="n1:setId and n1:versionNumber">
      <table class="header_table">
        <tbody>
          <tr>
            <td class="td_header_role_name">
              <xsl:text>SetId og Version</xsl:text>
            </td>
            <td class="td_header_role_value">
  ...
  <xsl:template xmlns:n1="urn:hl7-org:v3" xmlns:in="urn:lantana-com:inline-variable-data" name="section-author">
    <xsl:if test="count(n1:author) &gt; 0">
      <div class="section-author">
        <span class="emphasis">
          <xsl:text>Udsteder for paragraf: </xsl:text>
        </span>
        <xsl:for-each select="n1:author/n1:assignedAuthor">
          <xsl:choose>
            <xsl:when test="n1:assignedPerson/n1:name">
  ...
  <xsl:template xmlns:n1="urn:hl7-org:v3" xmlns:in="urn:lantana-com:inline-variable-data" name="nestedSection">
    ...
    <xsl:choose>
      <xsl:when test="$tableheader != $title">-->
    <h4>
      <xsl:value-of select="$nestedtitle"/>
    </h4>
    <!--</xsl:when>
  </xsl:choose>-->
  ...
  <xsl:template xmlns:n1="urn:hl7-org:v3" xmlns:in="urn:lantana-com:inline-variable-data" name="show-sig">
    ...
    <xsl:choose>
      ...
      <xsl:when test="$sig/@code = 'I'">
        <xsl:text>beregnet</xsl:text>
      </xsl:when>
      <xsl:when test="$sig/@code = 'X'">
        <xsl:text>underskrift påkrævet</xsl:text>
      </xsl:when>
    </xsl:choose>
  </xsl:template>
  <!--  show-id -->
  <xsl:template xmlns:n1="urn:hl7-org:v3" xmlns:in="urn:lantana-com:inline-variable-data" name="show-id">
    ...
    <xsl:choose>
      <xsl:when test="not($id)">
        ...
        <xsl:text> </xsl:text>          <xsl:if test="not(@nullFlavor)">
  ...
  <xsl:template xmlns:n1="urn:hl7-org:v3" xmlns:in="urn:lantana-com:inline-variable-data" name="show-gender">
    <xsl:choose>
      ...
      <xsl:when test="@code = 'F' or @code = 'Female'">
        <xsl:text>Kvinde</xsl:text>
      </xsl:when>
      <xsl:when test="@code = 'UN' or @code = 'Undifferentiated'">
        <xsl:text>Uspecificeret</xsl:text>
      </xsl:when>
    </xsl:choose>
  </xsl:template>
  <!-- show-race-ethnicity  -->
  ...
  <xsl:template xmlns:n1="urn:hl7-org:v3" xmlns:in="urn:lantana-com:inline-variable-data" name="translateTelecomCode">
    ...
    <xsl:choose>
      ...
      <xsl:when test="$code = 'H'">
        <xsl:text>Hjemmeadresse</xsl:text>
      </xsl:when>
      <xsl:when test="$code = 'url'">
        <xsl:text>URL</xsl:text>
      </xsl:when>
      <xsl:when test="$code = 'HV'">
        <xsl:text>Ferieadresse</xsl:text>
      </xsl:when>
      <xsl:when test="$code = 'HP'">
        <xsl:text>Hjemmeadresse</xsl:text>
      </xsl:when>
      <xsl:when test="$code = 'WP'">
        <xsl:text>Arbejdsadresse</xsl:text>
      </xsl:when>
      <xsl:when test="$code = 'PUB'">
        <xsl:text>Offentlig adresse</xsl:text>
      </xsl:when>
      <xsl:when test="$code = 'TMP'">
        <xsl:text>Midlertidig adresse</xsl:text>
      </xsl:when>
      <xsl:when test="$code = 'BAD'">
        <xsl:text>Forkert eller udløbet</xsl:text>
      </xsl:when>
      <xsl:otherwise>
    ...
    <table class="header_table">
      <tbody>
        ...
        <tr>
          <td class="td_header_role_name">
            <span class="td_label">
              <xsl:text>Facilitets ID</xsl:text>
            </span>
          </td>
          <td class="td_header_role_value">
            <xsl:choose>
        ...
        <tr>
          <td class="td_header_role_name">
            <span class="td_label">
              <xsl:text>Første dato i rapporterede periode</xsl:text>
            </span>
          </td>
          <td class="td_header_role_value">
            <xsl:call-template name="show-time">
        ...
        <tr>
          <td class="td_header_role_name">
            <span class="td_label">
              <xsl:text>Sidste dato i rapporterede periode</xsl:text>
            </span>
          </td>
          <td class="td_header_role_value">
            <xsl:call-template name="show-time">
  ...
  <!--DXC-->
  <xsl:template xmlns:n1="urn:hl7-org:v3" xmlns:in="urn:lantana-com:inline-variable-data" name="translate-code">
    <xsl:param name="code"/>
    ...
    <xsl:choose>
      <xsl:when test="$value = 'Inpatient'">
        <xsl:text>Indlagt</xsl:text>
      </xsl:when>
      <xsl:when test="$value = 'Outpatient'">
        <xsl:text>Ambulant</xsl:text>
      </xsl:when>
      <xsl:otherwise>
        <xsl:value-of select="$value"/>
      </xsl:otherwise>
  ...
  <xsl:template xmlns:n1="urn:hl7-org:v3" xmlns:in="urn:lantana-com:inline-variable-data" name="show-actClassCode">
    ...
    <xsl:choose>
      <xsl:when test="$clsCode = 'ACT'">
        <xsl:text>sundhedsservice</xsl:text>
      </xsl:when>
      <xsl:when test="$clsCode = 'ACCM'">
        <xsl:text>ophold</xsl:text>
      </xsl:when>
      <xsl:when test="$clsCode = 'ACCT'">
        <xsl:text>konto</xsl:text>
      </xsl:when>
      <xsl:when test="$clsCode = 'ACSN'">
        <xsl:text>tiltrædelse</xsl:text>
      </xsl:when>
      <xsl:when test="$clsCode = 'ADJUD'">
        <xsl:text>økonomisk vurdering</xsl:text>
      </xsl:when>
      <xsl:when test="$clsCode = 'CONS'">
        <xsl:text>samtykke</xsl:text>
      </xsl:when>
      <xsl:when test="$clsCode = 'CONTREG'">
        <xsl:text>containerregistrering</xsl:text>
      </xsl:when>
      <xsl:when test="$clsCode = 'CTTEVENT'">
        <xsl:text>Klinisk forsøg tidsbestemt arrangement</xsl:text>
      </xsl:when>
      <xsl:when test="$clsCode = 'DISPACT'">
        <xsl:text>disciplinær handling</xsl:text>
      </xsl:when>
      <xsl:when test="$clsCode = 'ENC'">
        <xsl:text>kontakt</xsl:text>
      </xsl:when>
      <xsl:when test="$clsCode = 'INC'">
        <xsl:text>hændelse</xsl:text>
      </xsl:when>
      <xsl:when test="$clsCode = 'INFRM'">
        <xsl:text>informer</xsl:text>
      </xsl:when>
      <xsl:when test="$clsCode = 'INVE'">
        <xsl:text>Faktureringselement</xsl:text>
      </xsl:when>
      <xsl:when test="$clsCode = 'LIST'">
        <xsl:text>arbejdsliste</xsl:text>
      </xsl:when>
      <xsl:when test="$clsCode = 'MPROT'">
        <xsl:text>overvågningsprogram</xsl:text>
      </xsl:when>
      <xsl:when test="$clsCode = 'PCPR'">
        <xsl:text>plejeforordning</xsl:text>
      </xsl:when>
      ...
      <xsl:when test="$clsCode = 'REV'">
        <xsl:text>evaluering</xsl:text>
      </xsl:when>
      <xsl:when test="$clsCode = 'SBADM'">
        <xsl:text>stof administration</xsl:text>
      </xsl:when>
      <xsl:when test="$clsCode = 'SPCTRT'">
        <xsl:text>prøvebehandling</xsl:text>
      </xsl:when>
      <xsl:when test="$clsCode = 'SUBST'">
        <xsl:text>erstatning</xsl:text>
      </xsl:when>
      <xsl:when test="$clsCode = 'TRNS'">
        <xsl:text>transport</xsl:text>
      </xsl:when>
      <xsl:when test="$clsCode = 'VERIF'">
        <xsl:text>verificering</xsl:text>
      </xsl:when>
      <xsl:when test="$clsCode = 'XACT'">
        <xsl:text>financiel transaktion</xsl:text>
      </xsl:when>
    </xsl:choose>
  </xsl:template>
  ...
  <xsl:template xmlns:n1="urn:hl7-org:v3" xmlns:in="urn:lantana-com:inline-variable-data" name="show-participationType">
    ...
    <xsl:choose>
      <xsl:when test="$ptype = 'PPRF'">
        <xsl:text>primær udfører</xsl:text>
      </xsl:when>
      <xsl:when test="$ptype = 'PRF'">
        <xsl:text>udfører</xsl:text>
      </xsl:when>
      <xsl:when test="$ptype = 'VRF'">
        <xsl:text>verifikator</xsl:text>
      </xsl:when>
      <xsl:when test="$ptype = 'SPRF'">
        <xsl:text>anden udfører</xsl:text>
      </xsl:when>
    </xsl:choose>
  </xsl:template>
  ...
  <xsl:template xmlns:n1="urn:hl7-org:v3" xmlns:in="urn:lantana-com:inline-variable-data" name="show-participationFunction">
    ...
    <xsl:choose>
      ...
      <xsl:when test="$pFunction = 'ADMPHYS'">
        <xsl:text>(indlæggelseslæge)</xsl:text>
      </xsl:when>
      <xsl:when test="$pFunction = 'ANEST'">
        <xsl:text>(anæstesilæge)</xsl:text>
      </xsl:when>
      <xsl:when test="$pFunction = 'ANRS'">
        <xsl:text>(anæstesisygeplejerske)</xsl:text>
      </xsl:when>
      <xsl:when test="$pFunction = 'ATTPHYS'">
        <xsl:text>(besøgslæge)</xsl:text>
      </xsl:when>
      <xsl:when test="$pFunction = 'DISPHYS'">
        <xsl:text>(udskrivelseslæge)</xsl:text>
      </xsl:when>
      <xsl:when test="$pFunction = 'FASST'">
        <xsl:text>(første assisterende kirurg)</xsl:text>
      </xsl:when>
      <xsl:when test="$pFunction = 'MDWF'">
        <xsl:text>(Jordmor)</xsl:text>
      </xsl:when>
      <xsl:when test="$pFunction = 'NASST'">
        <xsl:text>(sygehjælper)</xsl:text>
      </xsl:when>
      <xsl:when test="$pFunction = 'PCP'">
        <xsl:text>(Praktiserende læge)</xsl:text>
      </xsl:when>
      <xsl:when test="$pFunction = 'PRISURG'">
        <xsl:text>(Ledende kirurg)</xsl:text>
      </xsl:when>
      <xsl:when test="$pFunction = 'RNDPHYS'">
        <xsl:text>(afrunding læge)</xsl:text>
      </xsl:when>
      <xsl:when test="$pFunction = 'SASST'">
        <xsl:text>(anden assisterende kirurg)</xsl:text>
      </xsl:when>
      <xsl:when test="$pFunction = 'SNRS'">
        <xsl:text>(forberedende sygeplejerske)</xsl:text>
      </xsl:when>
      <xsl:when test="$pFunction = 'TASST'">
        <xsl:text>(tredie assistent)</xsl:text>
      </xsl:when>
      <!-- From the HL7 v2 Provider Role code system (2.16.840.1.113883.12.443) which is used by HITSP -->
      <xsl:when test="$pFunction = 'CP'">
        <xsl:text>(Konsulterende udbyder)</xsl:text>
      </xsl:when>
      <xsl:when test="$pFunction = 'PP'">
        <xsl:text>(praktiserende udbyder)</xsl:text>
      </xsl:when>
      <xsl:when test="$pFunction = 'RP'">
        <xsl:text>(refererende udbyder)</xsl:text>
      </xsl:when>
      <xsl:when test="$pFunction = 'MP'">
        <xsl:text>(hjemmemedisinsk udbyder)</xsl:text>
      </xsl:when>
    </xsl:choose>
  </xsl:template>
  ...
  <xsl:template xmlns:n1="urn:hl7-org:v3" xmlns:in="urn:lantana-com:inline-variable-data" name="show-noneFlavor">
    ...
    <xsl:choose>
      <xsl:when test="$nf = 'NI'">
        <xsl:text>ingen information</xsl:text>
      </xsl:when>
      <xsl:when test="$nf = 'INV'">
        <xsl:text>ugyldig</xsl:text>
      </xsl:when>
      <xsl:when test="$nf = 'MSK'">
        <xsl:text>blokeret</xsl:text>
      </xsl:when>
      <xsl:when test="$nf = 'NA'">
        <xsl:text>ikke anvendelig</xsl:text>
      </xsl:when>
      <xsl:when test="$nf = 'UNK'">
        <xsl:text>ukendt</xsl:text>
      </xsl:when>
      <xsl:when test="$nf = 'OTH'">
        <xsl:text>andet</xsl:text>
      </xsl:when>
    </xsl:choose>
  </xsl:template>
  ...
  <xsl:template xmlns:n1="urn:hl7-org:v3" xmlns:in="urn:lantana-com:inline-variable-data" name="translate-id-type">
    ...
    <xsl:choose>
      <xsl:when test="$id-oid = '1.2.208.176.1.2'">
        <xsl:text>CPR-nummer</xsl:text>
      </xsl:when>
      ...
      <xsl:when test="$id-oid = '2.16.840.1.113883.19.5'">
        <xsl:text>Meningsløs identifikator, der ikke skal bruges til nogen egentlige enheder. Kun eksempler.</xsl:text>
      </xsl:when>
