...
Item: (HealthConcernSubSectionCDASection)
-->
    <rule context="*[hl7:section[hl7:templateId[@root = '1.2.208.184.15.1.10.20.1.2'][@extension = '2018-11-28']]]/hl7:section[hl7:templateId[@root = '1.2.208.184.15.1.10.20.1.2'][@extension = '2018-11-28']]" id="d34719091e1270-false-d38348521e0">
...
Item: (HealthConcernSubSectionCDASection)
-->
    <rule context="*[hl7:section[hl7:templateId[@root = '1.2.208.184.15.1.10.20.1.2'][@extension = '2018-11-28']]]/hl7:section[hl7:templateId[@root = '1.2.208.184.15.1.10.20.1.2'][@extension = '2018-11-28']]/hl7:templateId[@root = '1.2.208.184.15.1.10.20.1.2'][@extension = '2018-11-28']" id="d34719091e1273-false-d38348692e0">
        <extends rule="II"/>
...
Item: (HealthConcernSubSectionCDASection)
-->
    <rule context="*[hl7:section[hl7:templateId[@root = '1.2.208.184.15.1.10.20.1.2'][@extension = '2018-11-28']]]/hl7:section[hl7:templateId[@root = '1.2.208.184.15.1.10.20.1.2'][@extension = '2018-11-28']]/hl7:id" id="d34719091e1276-false-d38348711e0">
        <extends rule="II"/>
        <assert role="error" see="http://art-decor.org/art-decor/decor-templates--medcom-documents-?id=1.2.208.184.15.1.10.20.1.2" test="(local-name-from-QName(resolve-QName(@xsi:type,.))='II' and namespace-uri-from-QName(resolve-QName(@xsi:type,.))='urn:hl7-org:v3') or not(@xsi:type)">(HealthConcernSubSectionCDASection): If an @xsi:type instruction is present it SHALL be valued "{urn:hl7-org:v3}:II". Found "{<value-of select="namespace-uri-from-QName(resolve-QName(@xsi:type,.))"/>}:<value-of select="local-name-from-QName(resolve-QName(@xsi:type,.))"/>"</assert>
    </rule>
   <!--
...
Item: (HealthConcernSubSectionCDASection)
-->
    <rule context="*[hl7:section[hl7:templateId[@root = '1.2.208.184.15.1.10.20.1.2'][@extension = '2018-11-28']]]/hl7:section[hl7:templateId[@root = '1.2.208.184.15.1.10.20.1.2'][@extension = '2018-11-28']]/hl7:code[(@code = '75310-3' and @codeSystem = '2.16.840.1.113883.6.1')]" id="d34719091e1277-false-d38348721e0">
        <extends rule="CE"/>
...
Item: (HealthConcernSubSectionCDASection)
-->
    <rule context="*[hl7:section[hl7:templateId[@root = '1.2.208.184.15.1.10.20.1.2'][@extension = '2018-11-28']]]/hl7:section[hl7:templateId[@root = '1.2.208.184.15.1.10.20.1.2'][@extension = '2018-11-28']]/hl7:title" id="d34719091e1279-false-d38348736e0">
        <extends rule="ST"/>
...
Item: (HealthConcernSubSectionCDASection)
-->
    <rule context="*[hl7:section[hl7:templateId[@root = '1.2.208.184.15.1.10.20.1.2'][@extension = '2018-11-28']]]/hl7:section[hl7:templateId[@root = '1.2.208.184.15.1.10.20.1.2'][@extension = '2018-11-28']]/hl7:text" id="d34719091e1280-false-d38348745e0">
...
Item: (HealthConcernSubSectionCDASection)
-->
    <rule context="*[hl7:section[hl7:templateId[@root = '1.2.208.184.15.1.10.20.1.2'][@extension = '2018-11-28']]]/hl7:section[hl7:templateId[@root = '1.2.208.184.15.1.10.20.1.2'][@extension = '2018-11-28']]/hl7:confidentialityCode[concat(@code, @codeSystem) = doc('include/voc-2.16.840.1.113883.1.11.16926-DYNAMIC.xml')//valueSet[1]/conceptList/concept/concat(@code, @codeSystem) or @nullFlavor]" id="d34719091e1281-false-d38348757e0">
        <extends rule="CE"/>
        <assert role="error" see="http://art-decor.org/art-decor/decor-templates--medcom-documents-?id=1.2.208.184.15.1.10.20.1.2" test="(local-name-from-QName(resolve-QName(@xsi:type,.))='CE' and namespace-uri-from-QName(resolve-QName(@xsi:type,.))='urn:hl7-org:v3') or not(@xsi:type)">(HealthConcernSubSectionCDASection): If an @xsi:type instruction is present it SHALL be valued "{urn:hl7-org:v3}:CE". Found "{<value-of select="namespace-uri-from-QName(resolve-QName(@xsi:type,.))"/>}:<value-of select="local-name-from-QName(resolve-QName(@xsi:type,.))"/>"</assert>
...
Item: (HealthConcernSubSectionCDASection)
-->
    <rule context="*[hl7:section[hl7:templateId[@root = '1.2.208.184.15.1.10.20.1.2'][@extension = '2018-11-28']]]/hl7:section[hl7:templateId[@root = '1.2.208.184.15.1.10.20.1.2'][@extension = '2018-11-28']]/hl7:languageCode" id="d34719091e1283-false-d38348779e0">
        <extends rule="CS"/>
