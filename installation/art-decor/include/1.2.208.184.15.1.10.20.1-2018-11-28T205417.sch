...
Item: (HealthConcernSection)
-->
    <rule context="*[hl7:section[hl7:templateId[@root = '1.2.208.184.15.1.10.20.1'][@extension = '2018-09-28']]]/hl7:section[hl7:templateId[@root = '1.2.208.184.15.1.10.20.1'][@extension = '2018-09-28']]" id="d15974401e886-false-d19621212e0">
...
Item: (HealthConcernSection)
-->
    <rule context="*[hl7:section[hl7:templateId[@root = '1.2.208.184.15.1.10.20.1'][@extension = '2018-09-28']]]/hl7:section[hl7:templateId[@root = '1.2.208.184.15.1.10.20.1'][@extension = '2018-09-28']]/hl7:templateId[@root = '1.2.208.184.15.1.10.20.1'][@extension = '2018-09-28']" id="d15974401e889-false-d19621754e0">
        <extends rule="II"/>
...
Item: (HealthConcernSection)
-->
    <rule context="*[hl7:section[hl7:templateId[@root = '1.2.208.184.15.1.10.20.1'][@extension = '2018-09-28']]]/hl7:section[hl7:templateId[@root = '1.2.208.184.15.1.10.20.1'][@extension = '2018-09-28']]/hl7:id" id="d15974401e892-false-d19621773e0">
        <extends rule="II"/>
        <assert role="error" see="http://art-decor.org/art-decor/decor-templates--medcom-documents-?id=1.2.208.184.15.1.10.20.1" test="(local-name-from-QName(resolve-QName(@xsi:type,.))='II' and namespace-uri-from-QName(resolve-QName(@xsi:type,.))='urn:hl7-org:v3') or not(@xsi:type)">(HealthConcernSection): If an @xsi:type instruction is present it SHALL be valued "{urn:hl7-org:v3}:II". Found "{<value-of select="namespace-uri-from-QName(resolve-QName(@xsi:type,.))"/>}:<value-of select="local-name-from-QName(resolve-QName(@xsi:type,.))"/>"</assert>
    </rule>
   <!--
...
Item: (HealthConcernSection)
-->
    <rule context="*[hl7:section[hl7:templateId[@root = '1.2.208.184.15.1.10.20.1'][@extension = '2018-09-28']]]/hl7:section[hl7:templateId[@root = '1.2.208.184.15.1.10.20.1'][@extension = '2018-09-28']]/hl7:code[(@code = '75310-3' and @codeSystem = '2.16.840.1.113883.6.1')]" id="d15974401e893-false-d19621783e0">
        <extends rule="CE"/>
...
Item: (HealthConcernSection)
-->
    <rule context="*[hl7:section[hl7:templateId[@root = '1.2.208.184.15.1.10.20.1'][@extension = '2018-09-28']]]/hl7:section[hl7:templateId[@root = '1.2.208.184.15.1.10.20.1'][@extension = '2018-09-28']]/hl7:title[not(@nullFlavor)]" id="d15974401e895-false-d19621798e0">
        <extends rule="ST"/>
...
Item: (HealthConcernSection)
-->
    <rule context="*[hl7:section[hl7:templateId[@root = '1.2.208.184.15.1.10.20.1'][@extension = '2018-09-28']]]/hl7:section[hl7:templateId[@root = '1.2.208.184.15.1.10.20.1'][@extension = '2018-09-28']]/hl7:text[not(@nullFlavor)]" id="d15974401e896-false-d19621807e0">
...
Item: (HealthConcernSection)
-->
    <rule context="*[hl7:section[hl7:templateId[@root = '1.2.208.184.15.1.10.20.1'][@extension = '2018-09-28']]]/hl7:section[hl7:templateId[@root = '1.2.208.184.15.1.10.20.1'][@extension = '2018-09-28']]/hl7:confidentialityCode[concat(@code, @codeSystem) = doc('include/voc-2.16.840.1.113883.1.11.16926-DYNAMIC.xml')//valueSet[1]/conceptList/concept/concat(@code, @codeSystem) or @nullFlavor]" id="d15974401e897-false-d19621819e0">
        <extends rule="CE"/>
        <assert role="error" see="http://art-decor.org/art-decor/decor-templates--medcom-documents-?id=1.2.208.184.15.1.10.20.1" test="(local-name-from-QName(resolve-QName(@xsi:type,.))='CE' and namespace-uri-from-QName(resolve-QName(@xsi:type,.))='urn:hl7-org:v3') or not(@xsi:type)">(HealthConcernSection): If an @xsi:type instruction is present it SHALL be valued "{urn:hl7-org:v3}:CE". Found "{<value-of select="namespace-uri-from-QName(resolve-QName(@xsi:type,.))"/>}:<value-of select="local-name-from-QName(resolve-QName(@xsi:type,.))"/>"</assert>
...
Item: (HealthConcernSection)
-->
    <rule context="*[hl7:section[hl7:templateId[@root = '1.2.208.184.15.1.10.20.1'][@extension = '2018-09-28']]]/hl7:section[hl7:templateId[@root = '1.2.208.184.15.1.10.20.1'][@extension = '2018-09-28']]/hl7:languageCode" id="d15974401e899-false-d19621841e0">
        <extends rule="CS"/>
...
-->
    <rule context="*[hl7:section[hl7:templateId[@root = '1.2.208.184.15.1.10.20.1'][@extension = '2018-09-28']]]/hl7:section[hl7:templateId[@root = '1.2.208.184.15.1.10.20.1'][@extension = '2018-09-28']]/hl7:entry">
        <extends rule="d19623850e0-false-d19624837e0"/>
...
-->
    <rule id="d19623850e0-false-d19624837e0" abstract="true">
