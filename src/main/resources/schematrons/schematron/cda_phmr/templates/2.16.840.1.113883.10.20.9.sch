...
<!ENTITY baseURI "">
<!ENTITY ent-2.16.840.1.113883.10.20.9 SYSTEM '2.16.840.1.113883.10.20.9.ent'>
]>
<schema xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:cda="urn:hl7-org:v3">

    <title>CDA PHMR Header Constraints</title>
    ...
    <phase id='note'>
        <!--<active pattern='p-2.16.840.1.113883.10.20.9-note'/> -->
    </phase>
